...
function MailCheck() {
  ...
  const handleEmailCheck = async () => {
    const response = await fetch('https://project3-backend-d1f6.onrender.com/users/checkmail', {
      method: 'POST',
  ...
  const handlePasswordReset = async () => {
    const response = await fetch(`https://project3-backend-d1f6.onrender.com/users/checkstring?token=${string}`, {
      method: 'POST',
